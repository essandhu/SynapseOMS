...
- [x] dashboard/src/stores/insightStore.ts (Zustand AI insights state — 5 tests)
...
- [x] dashboard/src/views/InsightsPanel.tsx (tabbed: execution analysis, rebalancing NL input, anomaly alerts — 3 tests)
...
- [x] ai/execution_analyst/analyst.py (Anthropic API integration, ExecutionAnalyst class with rate limiting)
- [x] ai/execution_analyst/prompt_templates.py (EXECUTION_ANALYSIS_PROMPT template)
- [x] ai/rebalancing_assistant/assistant.py (NL -> optimizer constraints via Anthropic API, validation)
- [x] ai/rebalancing_assistant/prompt_templates.py (CONSTRAINT_EXTRACTION_PROMPT template)
...
- [x] risk_engine/anomaly/detector_test.py (anomaly detector tests — 11 tests in tests/test_anomaly_detector.py)
...
- [x] risk_engine/tests/test_anomaly.py (anomaly detection tests — covered by test_anomaly_detector.py + test_anomaly_consumer.py)
- [x] ai/execution_analyst/analyst_test.py (execution analyst tests — 11 tests in tests/)
- [x] ai/rebalancing_assistant/assistant_test.py (rebalancing assistant tests — 10 tests in tests/)
