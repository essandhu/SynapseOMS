...
- [x] dashboard/src/views/RiskDashboard.tsx (VaR gauges, drawdown chart, settlement timeline) — PARTIAL: MC histogram and Greeks heatmap are Phase 3
...
- [x] deploy/docker-compose.yml (gateway, risk-engine, dashboard, kafka, postgres, redis) — Phase 2: added kafka + risk-engine
